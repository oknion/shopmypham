...
class Vt_Flycart_Block_Checkout_Cart_Item_Renderer extends Mage_Bundle_Block_Checkout_Cart_Item_Renderer
{
    ...
    {                       
        ...
        if ($rendered && ($rendered->getNameInLayout() == 'cart_sidebar' || $rendered->getName() == 'cart_sidebar') &&
             $helper->isActivated() && Mage::getStoreConfig('flycart/qtyupdate/cart_block'))
        {                    
