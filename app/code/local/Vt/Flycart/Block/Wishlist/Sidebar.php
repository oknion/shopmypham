...
class Vt_Flycart_Block_Wishlist_Sidebar extends Mage_Wishlist_Block_Customer_Sidebar
{

    public function getItemRemoveUrl($item)
    {
        if (Mage::helper('flycart')->isActivated()){
            return 'javascript:ajaxcartConfig.deleteWishlistItem(\'' . $this->getUrl(
                'flycart/index/removeWishlistItem',
                array(
