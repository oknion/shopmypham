<?php
class Vt_Ajaxfilter_Block_Catalog_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price
{
		...
		if($this->isTextBoxEnabled()){
			$html = '
				<div class="text-box"><div class="price-from">
					'.$this->getCurrencySymbol().' <input type="text" name="min" id="minPrice" class="priceTextBox" value="'.$this->getCurrMinPrice().'"/></div><div class="price-to"> <input type="text" name="max" id="maxPrice" class="priceTextBox" value="'.$this->getCurrMaxPrice().'"/></div>					
					<a class="go" href="javascript:void(0)">'.$this->getGoBtnText().'</a>
