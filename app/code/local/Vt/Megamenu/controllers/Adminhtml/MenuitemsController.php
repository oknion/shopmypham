...
class Vt_Megamenu_Adminhtml_MenuitemsController extends Mage_Adminhtml_Controller_action{
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			if(!$this->getRequest()->getParam('id')){
				Mage::dispatchEvent('megamenu_menuitems_setItemLR_before',array('menuitems'=>$model));
			}
			else{
			...
			try {
				...
				$model->save();
				if(!$this->getRequest()->getParam('id')){
					Mage::dispatchEvent('megamenu_menuitems_updateItemsLR_after',array('menuitems'=>$model));
				}
				else{
