...
DROP TABLE IF EXISTS {$this->getTable('vt_menu_groups')};
CREATE TABLE {$this->getTable('vt_menu_groups')} (
...
DROP TABLE IF EXISTS {$this->getTable('vt_menu_items')};
CREATE TABLE {$this->getTable('vt_menu_items')} (
  `id` int(11) unsigned NOT NULL auto_increment,
  `title` varchar(255) NOT NULL default '',
