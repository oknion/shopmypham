...
class Vt_Megamenu_Block_Adminhtml_Menuitems_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	protected function _prepareCollection(){
		...
		$collection ->getSelect()
				...
				->columns('CONCAT( REPEAT( "'.Vt_Megamenu_Model_System_Config_Source_Prefix::PREFIX.'   ", (COUNT(parent.depth) - 1) ) , main_table.title) AS name')
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('group_name', array(
			...
			'index'     => 'group_name',
			'type'      => 'options',
			'options'   => Vt_Megamenu_Model_System_Config_Source_ListGroup::getOptionArray(),	
