...
namespace Sm\BasicProducts\Block\Cache;
...
class Lite
{
    ...
    */
	//const CACHE_LITE_ERROR_RETURN =1;
	//const CACHE_LITE_ERROR_DIE = 8;
    var $_cacheDir = '/tmp/';
    ...
    * This option can speed up Lite only when you have many thousands of 
    ...
    */
    ...
    /**
    * Generic way to set a Lite option
    *
    * see Lite constructor for available options
    *
    ...
    */
    ...
    {
       var_dump($msg , $code); die('Error Load Cache File');
