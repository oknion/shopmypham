...
namespace Sm\Lovefashion\Model\Import;
...
class Cms
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Sm/Lovefashion/etc/import/';
    ...
    public function importCms($type)
    {
        ...
        try {
            ...
            if($this->_scopeConfig->getValue("lovefashion/theme_install/overwrite_".$type)) {
                $overwrite = true;
            }
