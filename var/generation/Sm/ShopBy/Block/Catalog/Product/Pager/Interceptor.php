<?php
namespace Sm\ShopBy\Block\Catalog\Product\Pager;

/**
 * Interceptor class for @see \Sm\ShopBy\Block\Catalog\Product\Pager
 */
class Interceptor extends \Sm\ShopBy\Block\Catalog\Product\Pager implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Data\Helper\PostHelper $postDataHelper, \Magento\Catalog\Model\Layer\Resolver $layerResolver, \Magento\Catalog\Api\CategoryRepositoryInterface $categoryRepository, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Framework\ObjectManagerInterface $objectManager, $attr = null, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $postDataHelper, $layerResolver, $categoryRepository, $urlHelper, $objectManager, $attr, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_helper');
        if (!$pluginInfo) {
            return parent::_helper();
        } else {
            return $this->___callPlugins('_helper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_prepareLayout');
        if (!$pluginInfo) {
            return parent::_prepareLayout();
        } else {
            return $this->___callPlugins('_prepareLayout', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getCfg');
        if (!$pluginInfo) {
            return parent::_getCfg($attr, $data);
        } else {
            return $this->___callPlugins('_getCfg', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getConfig');
        if (!$pluginInfo) {
            return parent::_getConfig($name, $value_def);
        } else {
            return $this->___callPlugins('_getConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_setConfig');
        if (!$pluginInfo) {
            return parent::_setConfig($name, $value);
        } else {
            return $this->___callPlugins('_setConfig', func_get_args(), $pluginInfo);
        }
    }
